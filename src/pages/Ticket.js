...
export default function Tiket() {
    ...
    <img class="imgLogoP" src="./src/img/logo.png">
  ...
  <br>
      ...
      <h4 style="color: #fff; font-size: 12px; "> antes que perca a oportunidade [${toke.length}] de [1]</h4>
  <br>
 
  <br>
 
  <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdwSdocVw4zAEvYDeaLRhBmZwGPdRdz3mU59365NeTJLF5l1A/viewform?embedded=true" width="500" height="300" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" >Carregando…</iframe>
